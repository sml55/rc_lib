...
syn include @csharpTop syntax/csharp.vim

syn region csharpBlock matchgroup=aspnetCsharpDelim start=#<%=\?# end=#%># keepend containedin=ALL contains=@csharpTop,csharpEnd
